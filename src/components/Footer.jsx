...
function Footer() {
    return (
        <div className='flex w-full h-screen pt-20 px-20 bg-zinc-800 rounded-tl-3xl rounded-tr-3xl'>
            <div className='w-1/2  h-full flex flex-col justify-between'>
                <div className="heading font-['Founders_Grotesk
            ']">
                    <h1 className='text-[7vw] font-regular uppercase leading-none tracking-tighter -mb-5'>Eye-</h1>
                    <h1 className='text-[7vw] font-regular uppercase leading-none tracking-tighter -mb-5'>opening</h1>
                </div>
            ...
            <div className='w-1/2 font-["Neue_Montreal"] relative'>
                <h1 className='text-[7vw] font-regular uppercase leading-none tracking-tighter -mb-5'>Presentations</h1>

                <div className='s mt-14 text-xl px-1'>
                    S:
                </div>

                <div className='dets text-white mt-10'>
                    {['Instagram', 'Behamce', 'Facebook', 'Linkedin'].map((item) => { return <a className='block text-lg font-light text hover:underline' href='#'>{item}</a> }
                    )}
                </div>

                <div className='s mt-14 text-xl'>
                    L:
                </div>

                <div className='dets text-white mt-10'>
                    {['202-1965 W 4th Ave', 'Vancouver, Canada', ' ', '20 Chukarina St', 'Lviv, Ukraine'].map((item) => { return <a className='block text-lg font-light text hover:underline' href='#'>{item}</a> }
                    )}
                </div>
                ...
                <div className='dets text-white mt-10'>
                    {['hello@ochi.design'].map((item) => { return <a className='block text-lg font-light text hover:underline' href='https://ochi.design/' target='/'>{item}</a> }
                    )}
                </div>
                ...
                <div className=' absolute bottom-20 right-5'>
                    ...
                    <div className='dets text-white mt-10'>
                        {['Home', 'Service', 'Our Work', 'About Us', 'Insights', 'Contact Us'].map((item) => { return <a className='block text-lg font-light text hover:underline' href='#'>{item}</a> }
                        )}
                    </div>
                </div>
            </div>
